...
function SaveNoteAs() {
  ...
  getPHPFile.open("POST", "https://notehubserverside.x10host.com//handlers/filing.php", true);
...
function GetNote(topic, noteID) {
  ...
  getPHPFile.open("GET", "https://notehubserverside.x10host.com//handlers/filing.php?requestedFunction=read&topic=" + topic + "&noteId=" + noteID, true);
  getPHPFile.send();
}
